...
```bash
git clone https://github.com/AyushPoojariUCD/k8s-chat-application.git
```
...
```bash
git clone https://github.com/AyuchPoojariUCD/k8s-chat-application.git
```
